...
/* enumerations from "./cogl-pipeline.h" */
GType cogl_pipeline_filter_get_type (void) G_GNUC_CONST;
#define COGL_TYPE_PIPELINE_FILTER (cogl_pipeline_filter_get_type())

GType cogl_pipeline_wrap_mode_get_type (void) G_GNUC_CONST;
#define COGL_TYPE_PIPELINE_WRAP_MODE (cogl_pipeline_wrap_mode_get_type())

GType cogl_pipeline_alpha_func_get_type (void) G_GNUC_CONST;
#define COGL_TYPE_PIPELINE_ALPHA_FUNC (cogl_pipeline_alpha_func_get_type())
