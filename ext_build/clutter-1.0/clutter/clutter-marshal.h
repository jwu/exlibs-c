...
/* BOXED:UINT,UINT (./clutter-marshal.list:3) */
...
/* DOUBLE:VOID (./clutter-marshal.list:4) */
...
/* UINT:VOID (./clutter-marshal.list:5) */
...
/* VOID:BOXED (./clutter-marshal.list:6) */
#define _clutter_marshal_VOID__BOXED	g_cclosure_marshal_VOID__BOXED

/* VOID:BOXED,FLAGS (./clutter-marshal.list:7) */
...
/* VOID:INT (./clutter-marshal.list:8) */
#define _clutter_marshal_VOID__INT	g_cclosure_marshal_VOID__INT

/* VOID:INT64,INT64,FLOAT,BOOLEAN (./clutter-marshal.list:9) */
...
/* VOID:INT,INT (./clutter-marshal.list:10) */
...
/* VOID:FLOAT,FLOAT (./clutter-marshal.list:11) */
...
/* VOID:INT,INT,INT,INT (./clutter-marshal.list:12) */
...
/* VOID:OBJECT (./clutter-marshal.list:13) */
#define _clutter_marshal_VOID__OBJECT	g_cclosure_marshal_VOID__OBJECT

/* VOID:OBJECT,FLOAT,FLOAT (./clutter-marshal.list:14) */
...
/* VOID:OBJECT,FLOAT,FLOAT,FLAGS (./clutter-marshal.list:15) */
...
/* VOID:OBJECT,INT (./clutter-marshal.list:16) */
extern void _clutter_marshal_VOID__OBJECT_INT (GClosure     *closure,
                                               GValue       *return_value,
                                               guint         n_param_values,
                                               const GValue *param_values,
                                               gpointer      invocation_hint,
...
/* VOID:OBJECT,PARAM (./clutter-marshal.list:17) */
...
/* VOID:OBJECT,POINTER (./clutter-marshal.list:18) */
...
/* VOID:OBJECT,UINT (./clutter-marshal.list:19) */
...
/* VOID:POINTER (./clutter-marshal.list:20) */
#define _clutter_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:STRING,BOOLEAN,BOOLEAN (./clutter-marshal.list:21) */
...
/* VOID:STRING,INT (./clutter-marshal.list:22) */
