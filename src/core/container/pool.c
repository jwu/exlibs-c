...
// managed
ex_pool_t *ex_pool_alloc ( size_t _element_typeid, size_t _element_bytes, size_t _count )
{
    ex_pool_t *pool = ex_malloc ( sizeof(ex_pool_t) );
    ex_pool_init( pool, _element_typeid, _element_bytes, _count,
                  __ex_pool_alloc,
                  __ex_pool_realloc,
                  __ex_pool_dealloc
                );
                  ...
                  )
{
    ...
    _pool->element_typeid = _element_typeid;
