...
extern inline void ex_vec2f_get_neg ( ex_vec2f_t* _r, ex_vec2f_t* _v ) { 
...
extern inline bool ex_vec2f_get_normalize ( ex_vec2f_t* _r, ex_vec2f_t* _v ) {
...
extern inline void ex_vec2f_project_to ( ex_vec2f_t* _r, ex_vec2f_t* _from, ex_vec2f_t* _to ) {
    float projection;
...
extern inline void ex_vec2f_perpendicular_to ( ex_vec2f_t* _r, ex_vec2f_t* _from, ex_vec2f_t* _to ) {
    ex_vec2f_t v;
    ex_assert ( ex_vec2f_is_normalized(_to), "vector _to must be normalized." );
