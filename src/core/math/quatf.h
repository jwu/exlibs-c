...
inline void ex_quatf_set_from_axis_radians ( ex_quatf_t* _r, ex_vec3f_t* _axis, float _radians ) { 
    float half_radian;
...
inline void ex_quatf_get_neg ( ex_quatf_t* _r, ex_quatf_t* _q ) { 
...
// ------------------------------------------------------------------ 
/*! 
 @fn bool ex_quatf_get_inverse ( ex_quatf_t* _r, ex_quatf_t* _q )
 @retval _r the result quaternion
...
// ------------------------------------------------------------------ 
/*! 
 @fn bool ex_quatf_get_normalize( ex_quatf_t* _r, ex_quatf_t* _q )
 @retval _r the result quaternion
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_to_mat33( ex_quatf_t* _q, ex_mat33f_t* _m )
 @param _q the in quaternion
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_to_mat44( ex_quatf_t* _q, ex_mat44f_t* _m )
 @param _q the in quaternion
 @retval _m the converted matrix
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_to_axis_xyz( ex_quatf_t* _q, ex_vec3f_t* _x, ex_vec3f_t* _y, ex_vec3f_t* _z )
 @param _q the in quaternion
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_get_axis_x( ex_vec3f_t* _r, ex_quatf_t* _q )
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_get_axis_y( ex_vec3f_t* _r, ex_quatf_t* _q )
...
// ------------------------------------------------------------------ 
/*! 
 @fn void ex_quatf_get_axis_z( ex_vec3f_t* _r, ex_quatf_t* _q )
